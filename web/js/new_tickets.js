$(function(){
	...
	$(".crm_tikets").on('click', ".my_button", function(){
		...
		$.ajax({
			url: 'https://igoevent.com/site/formapi?id='+date_id,
			dataType : "json",
			success: function (tickets) {
				...
				$(".mypopup .my_tick").append('<input type="hidden" name="event_id" value="'+ tickets.event.id +'">');
				$(".mypopup .submit").html(tickets.event.button);
				// console.log(tickets);
			}               
		});
	$(".mypopup").fadeIn();
