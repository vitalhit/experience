...
<div class="row">
    <div class="col-xs-12 col-lg-3">
        <?php if ($model->foto) { echo '<img src="/uploads/users/'.$model->foto.'" class="img-responsive">';}
        echo $form->field($model, 'foto')->textInput(); ?>
        <?php if ($model->map) { echo '<img src="/uploads/users/'.$model->map.'" class="img-responsive">';}
        echo $form->field($model, 'map')->textInput(); ?>
        <?php if ($model->shema) { echo '<img src="/uploads/users/'.$model->shema.'" class="img-responsive">';}
        echo $form->field($model, 'shema')->textInput(); ?>
        <?php if ($model->foto_street) { echo '<img src="/uploads/users/'.$model->foto_street.'" class="img-responsive">';}
        echo $form->field($model, 'foto_street')->textInput(); ?>
        <?php if ($model->foto_stage) { echo '<img src="/uploads/users/'.$model->foto_stage.'" class="img-responsive">';}
        echo $form->field($model, 'foto_stage')->textInput(); ?>
        <?php if ($model->foto_hall) { echo '<img src="/uploads/users/'.$model->foto_hall.'" class="img-responsive">';}
        echo $form->field($model, 'foto_hall')->textInput(); ?>
        <?php if ($model->foto_seats) { echo '<img src="/uploads/users/'.$model->foto_seats.'" class="img-responsive">';}
        echo $form->field($model, 'foto_seats')->textInput(); ?>
