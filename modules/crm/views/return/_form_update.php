	...
	<div class="row">
		<div class="col-xs-12 col-lg-8">
			<div class="row">
				...
				<div class="col-xs-12 col-lg-5">
					<?= $form->field($model, 'ticket_id')->textInput(['readonly' => 'readonly']) ?>
				</div>
			</div>
		...
		<div class="col-xs-12 col-lg-12">
			<div class="row">
				<div class="col-xs-12 col-lg-4">                                    
					<?= $form->field($model, 'price_for_eventer')->textInput() ?>
				</div>
				<div class="col-xs-12 col-lg-4">                                    
					<?= $form->field($model, 'price_for_person')->textInput() ?>
				</div>
				<div class="col-xs-12 col-lg-4">                                    
					<?= $form->field($model, 'price_for_igoevent')->textInput() ?>
				</div>
