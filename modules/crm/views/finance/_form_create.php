	...
	<div class="row">
		...
		<div class="col-xs-12 col-lg-4">
			<div class="row">
				...
				<div class="col-xs-6 col-lg-6">
					<?php echo $form->field($model, 'smena_id')
					->dropDownList(ArrayHelper::map(Smena::find()->orderBy(['id'=>SORT_DESC])->all(), 'id', 'title'), ['prompt' => 'Выберите ...', 'value' => ($model->smena_id?$model->smena_id:$smena)])	;
					?>
				</div>
				<div class="col-xs-12 col-lg-10">                                    
