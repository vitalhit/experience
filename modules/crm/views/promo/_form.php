...
use app\models\NewsmakersEventsType;
	...
	<div class="row">
		<div class="col-xs-12 col-lg-8">
			<div class="row">
				...
				<div class="col-xs-4 col-lg-3">
				<?php echo $form->field($model, 'type_id')->dropDownList(ArrayHelper::map(NewsmakersEventsType::find()->all(), 'id', 'name'), ['prompt' => 'Выберите ...']); ?>
				</div>
