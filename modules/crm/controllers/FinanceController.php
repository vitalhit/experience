...
/**
 * FinanceController implements the CRUD actions for EventFinance model.
 */
class FinanceController extends Controller
{
    ...
    public function actionAll( $show = False , $event_id = False)
    {
        $events = Events::find()->where(['events.id' => Biblioevents::EventsIdsAll()])->joinWith('biblioevents')->orderBy('date desc')->all();
        ...
        // print_r($allevents);
        // echo "</pre>";
        if ($show) return $this->render('all.twig', ['finance' => $finance, 'contrs' => $contrs, 'alleventfinances' => $alleventfinances]);
        $company = Companies::getCompany();

        return $this->render('all.twig', ['finance' => $finance, 'contrs' => $contrs,  'company' => $company]);
    }
    ...
    public function actionCreate($event_id = False, $tour_id = False, $from_contragent = False, $to_contragent = False, $name = False, $price = False, $state = False, $status = False, $biblioevent_id = False)
    {
        ...
        return $this->render('create', ['model' => $model, 'event_id' => $event_id, 'from_contragent' => $from_contragent, 'to_contragent' => $to_contragent, 'biblioevent_id' => $biblioevent_id, 'smena' => $smena]);
    }


    public function actionUpdate($id, $biblioevent_id = false)
    {
        ...
        return $this->render('update', ['model' => $model, 'event_id' => $model->event_id, 'biblioevent_id' => $biblioevent_id]);
    }
    ...
    public function actionContractfoursiz($id)
    {
        $model = EventFinance::findOne($id);
        ...
        $content = $this->renderPartial('/finance/doc/2022foursiz-03.twig', ['model' => $model, 'money' => $money, 'contragent1' => $contragent1, 'contragent2' => $contragent2, 'event' => $event, 'biblioevent' => $biblioevent, 'place' => $place]);
