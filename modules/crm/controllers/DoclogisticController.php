...
/**
 * DoclogisticController implements the CRUD actions for EventFinance model.
 */
class DoclogisticController extends Controller
{
    /**
     * {@inheritdoc}
     */
        ...
        public function actionIndex( $show = False )
    {
        ...
        // print_r($allevents);
        // echo "</pre>";
        if ($show) return $this->render('index.twig', ['finance' => $finance, 'contrs' => $contrs, 'allevents' => $allevents]);

        return $this->render('index.twig', ['finance' => $finance, 'contrs' => $contrs, 'allevents' => $allevents]);
    }
