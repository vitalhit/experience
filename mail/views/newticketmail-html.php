...
<table align="center" cellpadding="0" cellspacing="0" style="border:none;font-size:14px;line-height:19px;margin:0px auto;max-width:600px;width:100%">
	<tbody>
		...
		<tr>
			<td colspan="2"><a href="https://igoevent.com/site/ticket?barcode=<?= $ticket->barcode ?>" style="color:#fff;background: red;padding: 15px 20px 15px 50px;background: #f00 url('https://igoevent.com/web/images/printico.png') no-repeat 15px center;background-size:20px;border-radius: 30px;margin:20px auto;display:block;width:90px;" target="_blank">ВАШ БИЛЕТ</a></td>
		</tr>
		<tr>
			<td colspan="2">
				...
				-->
				<p style="font-size:12px;margin-bottom: 20px;">Билет подтверждает ваше право участвовать в мероприятии. Будьте готовы предъявить его организаторам в электронном и/или бумажном виде.<br> Само письмо не является билетом! Ваш билет доступен по ссылкам выше! 1</p>
