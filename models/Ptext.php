 ...
 */
class Ptext extends \yii\db\ActiveRecord
{
	/**
	 * {@inheritdoc}
	 */
	...
	public function Quote()
	{
		...
		foreach ($quotes as $quote) {
			...
			$im = imagecreatefromjpeg('https://igoevent.com/web/images/'.$_POST['fon'].'.jpg');

			$box = new Qbox($im);
			$box->setFontFace('/home/c/cc22220/public_html/web/fonts/myriad-set-pro_bold.ttf');
			...
			$box->draw($text.PHP_EOL.$quote->autor);

			$file = '/home/c/cc22220/public_html/web/quotes/'.$quote->id.'.png';
			$i++;
	...
	public function Quotekudago()
	{
		...
		$box = new Qbox($im);
		$box->setFontFace('/home/c/cc22220/public_html/web/fonts/PSS65__W.ttf');
		$box->setFontColor(new Qcolor($color_hex['red'], $color_hex['green'], $color_hex['blue']));
		...
		$file = '/home/c/cc22220/public_html/web/quotes/generated.png';
