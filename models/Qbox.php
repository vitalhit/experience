...
class Qbox
{
    ...
    public function __construct(&$image)
    {
        ...
        $this->strokeColor = new Qcolor(0, 0, 0);
    }

    /**
     * @param Color $color Font color
     */
    public function setFontColor(Qcolor $color)
    {
     ...
     */
    public function setStrokeColor(Qcolor $color)
    {
     ...
     */
    public function setTextShadow(Qcolor $color, $xShift, $yShift)
    {
     ...
     * @param Color $color Font color
     */
    public function setBackgroundColor(Qcolor $color)
    {
     ...
     */
    public function setTextWrapping()
    {
        $this->textWrapping = 2;
    }
    ...
    public function draw($text)
    {
        ...
        if ($this->debug) {
            ...
            $this->drawFilledRectangle(
                ...
                $this->box['width'],
                $this->box['height'],
                new Qcolor(rand(180, 255), rand(180, 255), rand(180, 255), 80)
            );
        }
        ...
        foreach ($lines as $line) {
            ...
            if ($this->debug) {
                ...
                $this->drawFilledRectangle(
                    ...
                    $boxWidth,
                    $lineHeightPx,
                    new Qcolor(rand(1, 180), rand(1, 180), rand(1, 180))
                );
            }
    ...
    protected function drawFilledRectangle($x, $y, $width, $height, Qcolor $color)
    {
    ...
    protected function drawInternal($x, $y, Qcolor $color, $text)
    {
        imagefttext(
            $this->im,
