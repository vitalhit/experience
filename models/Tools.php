...
class Tools extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['user_id', 'company_id', 'discount', 'sex', 'froms_id', 'sendmail', 'inside', 'sum_visits', 'sum_tickets', 'vk_id', 'fb_id','template_id'], 'integer'],
    ...
    {
        return $this->hasMany(Tools::className(), ['event_id' => 'id']);
