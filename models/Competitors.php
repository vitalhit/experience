 ...
 */
class Competitors extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'second_name', 'middle_name', 'mail', 'mail_gmail', 'mail_yandex', 'phone', 'status', 'groups', 'city', 'link_insta', 'link_tt'], 'string', 'max' => 255],
        ];
    }
