...
/**
 * This is the model class for table "bookingapi".
 *
 * @property int $id
 ...
 * @property int $price
 */
class Bookingapi extends \yii\db\ActiveRecord
{
	/**
	 * @inheritdoc
	 */
	...
	{
		return [
			[['company_id', 'status_id', 'mail'], 'required'],
			[['company_id', 'biblioevent_id','event_finance_id', 'event_id', 'list_id', 'person_id', 'subscribe', 'owner_id', 'status_id', 'sex', 'role', 'task_id', 'project_id', 'price', 'brand_id'], 'integer'],
			...
			[['from_url', 'name', 'second_name', 'thirdname', 'vk_id', 'fb_id', 'in_id', 'foto', 'birthday', 'mail', 'phone', 'sale', 'result', 'utm_source', 'utm_medium', 'utm_campaign', 'utm_content', 'utm_term', 'brand','link_site','link_photo','link_vk','link_fb','link_insta', 'link_tg'], 'string', 'max' => 255],
		];
	}
