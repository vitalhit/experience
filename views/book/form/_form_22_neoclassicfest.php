...
<div class="contragent-form">
    ...
    <?= $form->field($model, 'company_id')->hiddenInput(['value' => '29'])->label(false); ?>
    ...
    <?= $form->field($model, 'brand')->textInput(['maxlength' => true, 'placeholder' => 'Название коллектива']) ?>
    
    <?= $form->field($model, 'link_site')->textInput(['maxlength' => true, 'placeholder' => 'ссылки на сайт и соц. сети']) ?>
