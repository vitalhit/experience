...
<div class="contragent-form">
    ...
    <?= $form->field($model, 'company_id')->hiddenInput(['value' => '155'])->label(false); ?>

    <?= $form->field($model, 'status_id')->hiddenInput(['value' => '1'])->label(false); ?>
    
    <?= $form->field($model, 'from_url')->hiddenInput(['value' => 'https://igoevent.com/book/steampunkmarket'])->label(false); ?>
    ...
    <div class="col-xs-12 col-lg-12">
    <?= $form->field($model, 'message')->textarea(['rows' => 3, 'placeholder' => 'Описание (без смайликов-эмоджи!!! — с ними не будет работать!!)'])->label('Описание'); ?>
    </div>
    <div class="col-xs-12 col-lg-12">
