...
<div class="contragent-form">
    ...
    <?= $form->field($model, 'company_id')->hiddenInput(['value' => '151'])->label(false); ?>

    <?= $form->field($model, 'status_id')->hiddenInput(['value' => '1'])->label(false); ?>
    
    <?= $form->field($model, 'from_url')->hiddenInput(['value' => 'https://igoevent.com/book/exhcatsspb'])->label(false); ?>
